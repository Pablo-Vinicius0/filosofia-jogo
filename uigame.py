...
"}")
    ...
    def retranslateUi(self, Jogo):
        ...
        self.dica1_label.setText(_translate("Jogo", "Lorem Impsum Dolor Dotrume"))
        self.pontuacao_p1.setText(_translate("Jogo", "100"))
        self.pontuacao_p2.setText(_translate("Jogo", "100"))
        self.dica2_pontos.setText(_translate("Jogo", "9"))
        self.dica2_label.setText(_translate("Jogo", "Neymar Messi Cristiano Ronaldo"))
